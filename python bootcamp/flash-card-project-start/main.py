...
def next_card():
    ...
    canvas.itemconfig(card_wrd, text=current_card["French"], fill='black')
...
def flip_card():
    ...
    canvas.itemconfig(card_wrd, text=current_card['English'], fill='white')
...
card_wrd = canvas.create_text(400, 263, text="word", font=('Ariel', 40, 'bold'))
